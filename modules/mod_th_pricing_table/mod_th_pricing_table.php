<?php
/**
 * @subpackage	mod_th_pricing_table
 * @copyright	Copyright (C) 2012 - 2014 Themehippo. All rights reserved.
...
require JModuleHelper::getLayoutPath('mod_th_pricing_table', $params->get('layout'));