<?php
 ...
 class UniteBaseAdminClassRev extends UniteBaseClassRev{
		...
		public static function addCommonScripts(){
			...
			$urlJQuery = "http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js";
			...
			$urlJqueryUI = "http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.1/jquery-ui.min.js";
			...
			self::addStyleAbsoluteUrl('http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.1/themes/base/jquery-ui.css', 'jui-smoothness');
