		...
		<div class="carousel"  id="hippo-slider-<?php echo $moduleID ?>">
			...
			<div class="carousel-inner">
				...
				foreach($data as $slider){
					...
					?>
					<div class="item item-<?php echo ($i+1) ?> <?php echo $activeclass ?>" style="<?php echo $style ?>">
						<?php echo $video; ?>
						<div class="container">
							<div class="row">
			...
			<div class="carousel-control-wrapper">
				<a class="left" href="#hippo-slider-<?php echo $moduleID ?>" data-slide="prev">
					<span class="icon-arrow-up"></span>
				</a>

				<a class="right" href="#hippo-slider-<?php echo $moduleID ?>" data-slide="next">
