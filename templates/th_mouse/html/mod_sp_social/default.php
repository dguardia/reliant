...
?>	
	...
	<ul>
		...
		<?php if ($twitter) : //twitter ?>
			<li><a <?php echo $target ?> class="sp_social_twitter" title="<?php echo JText::_('SP_SOCIAL_TWITTER') ?>" href="http://www.twitter.com/<?php echo $twitter ?>"><i class="fa fa-twitter"></i></a></li>
		<?php endif; ?>	
		...
		<?php if ($vimeo) : //vimeo ?>
			<li><a <?php echo $target ?> title="<?php echo JText::_('SP_SOCIAL_VIMEO') ?>" href="http://www.vimeo.com/<?php echo $vimeo ?>"><i class="fa fa-vimeo"></i></a></li>
		<?php endif; ?>	
