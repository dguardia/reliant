<?php
/**
 * @version   $Id: index.php 54236 2012-07-10 22:04:13Z djamil $
...
?>
<div class="sprocket-mosaic <?php echo $parameters->get('moduleclass_sfx') ?>" data-mosaic="<?php echo $parameters->get('module_id'); ?>">
